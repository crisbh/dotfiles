...
return {
  ...
  s(
    { trig = "([%a%)%]%}])ij", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
    fmta("<>_{<>}", {
      f(function(_, snip)
        return snip.captures[1]
      end),
  ...
  s(
    { trig = "([%a%)%]%}])ab", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
    fmta("<>_{<>}", {
      f(function(_, snip)
        return snip.captures[1]
      end),
  ...
  postfix({
    ...
    snippetType = "autosnippet",
    dscr = "postfix hat when in math mode",
  }, { l("\\dot{" .. l.POSTFIX_MATCH .. "}") }, { condition = in_mathzone }),
  postfix({
    trig = "doot",
    match_pattern = [[[\\%w%.%_%-%"%']+$]],
    snippetType = "autosnippet",
    dscr = "postfix hat when in math mode",
  }, { l("\\ddot{" .. l.POSTFIX_MATCH .. "}") }, { condition = in_mathzone }),
  postfix({
    trig = "bar",
    match_pattern = [[[\\%w%.%_%-%"%']+$]],
    snippetType = "autosnippet",
    dscr = "postfix vec when in math mode",
  }, { l("\\bar{" .. l.POSTFIX_MATCH .. "}") }, { condition = in_mathzone }),
  postfix({
    trig = "til",
    match_pattern = [[[\\%w%.%_%-%"%']+$]],
    snippetType = "autosnippet",
  ...
  -- Derivative d/dx
  s(
    { trig = "([^%a])ddx", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
    fmta("\\frac{d <>}{dx}", {
      i(1),
    }),
    { condition = in_mathzone }
  ...
  -- Derivative d/dt
  s(
    { trig = "([^%a])ddt", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
    fmta("\\frac{d<>}{dt}", {
      i(1),
    }),
    { condition = in_mathzone }
  ...
  -- Derivative d/dx
  s(
    { trig = "([^%a])pdx", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
    fmta("\\frac{\\partial d<>}{\\partial x}", {
      i(1),
    }),
    { condition = in_mathzone }
  ),
  -- Derivative d/dt
  s(
    { trig = "([^%a])pdt", wordTrig = false, regTrig = true, snippetType = "autosnippet" },
    fmta("\\frac{\\partial d<>}{\\partial t}", {
      i(1),
    }),
    { condition = in_mathzone }
  ),
