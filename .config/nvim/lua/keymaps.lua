...
vim.keymap.set(
  "n",
  "<leader>tt",
  ":e $VAULT/0-tasks/todo.md<CR>",
  { desc = "Open [T]ODO list", noremap = true, silent = true }
)
--
...
vim.keymap.set(
  "n",
  "<leader>ta",
  ":e $VAULT/0-tasks/active.md<CR>",
  { desc = "Open [T]ODO [A]ctive list", noremap = true, silent = true }
)
--
